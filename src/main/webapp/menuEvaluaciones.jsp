...
<header class="header1">
    <div class="logo mt-1">
        <h2 style="font-weight: bold;"><a style="text-decoration: none; font-size: 25px; font-weight: inherit; color: inherit" href="<%=request.getContextPath()%>/EvaluacionesServlet">Bienvenido, <%=usuario.getNombre()%></a></h2>
    </div>
    <div class="logo mt-1">
